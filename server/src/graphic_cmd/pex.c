/*
** pex.c for zappy in PSU_2016_zappy/server/src/graphic_cmd
**
** Made by Antoine Baché
** Login   <antoine.bache@epitech.net>
**
** Started on  Tue Jun 27 20:01:51 2017 Antoine Baché
** Last update Tue Jun 27 21:06:49 2017 Antoine Baché
*/
			...
			char const * const arg)
{
  ...
  (void)data;
  (void)arg;
  LOG(LOG_DEBUG, "Treating graphic pex command");
  msg = zappy_alloc_message();
  if (msg)
    {
      msg->len = snprintf(buff, sizeof(buff), "pex %d\n", cli->id);
      if (msg->len != -1)
	msg->msg = strdup(buff);
