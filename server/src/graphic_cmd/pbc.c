/*
** pbc.c for zappy in PSU_2016_zappy/server/src/graphic_cmd
**
** Made by Antoine Baché
** Login   <antoine.bache@epitech.net>
**
** Started on  Tue Jun 27 20:01:51 2017 Antoine Baché
** Last update Tue Jun 27 21:14:58 2017 Antoine Baché
*/
					...
					char const * const arg)
{
  ...
  (void)data;
  LOG(LOG_DEBUG, "Treating graphic pbc command");
  msg = zappy_alloc_message();
  if (msg)
    {
      msg->len = snprintf(buff, sizeof(buff), "pbc %d %s\n", cli->id,
			  arg);
      if (msg->len != -1)
	msg->msg = strdup(buff);
