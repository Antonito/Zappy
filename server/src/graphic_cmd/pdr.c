/*
** pdr.c for zappy in PSU_2016_zappy/server/src/graphic_cmd
**
** Made by Antoine Baché
** Login   <antoine.bache@epitech.net>
**
** Started on  Tue Jun 27 20:01:51 2017 Antoine Baché
** Last update Fri Jun 30 21:13:58 2017 Antoine Baché
*/
					...
					char const * const arg)
{
  ...
  (void)data;
  (void)arg;
  LOG(LOG_DEBUG, "Treating graphic pdr command");
  play = g->ptr;
  msg = zappy_alloc_message();
  if (msg)
    {
      msg->len = snprintf(buff, sizeof(buff), "pdr %d %d\n", play->id,
			  g->res);
      if (msg->len != -1)
	msg->msg = strdup(buff);
